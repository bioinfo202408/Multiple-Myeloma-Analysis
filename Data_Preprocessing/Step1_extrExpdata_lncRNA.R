# lncRNA annotations from two sources
...
expData1 <- readStringtieData("/home/yjliu/mmProj/homo/procdata/GSE*/lncRNA/GENCODE/stringtie/*/gene_abund.tab")

## Read NONCODE annotation
expData2 <- readStringtieData("/home/yjliu/mmProj/homo/procdata/GSE*/lncRNA/NONCODE/stringtie/*/gene_abund.tab")
...
write.csv(expData_all, 
          file="/home/yjliu/mmProj/homo/procdata/Homo_lncRNA_TPM.csv", 
          row.names=FALSE, 
          quote=FALSE)