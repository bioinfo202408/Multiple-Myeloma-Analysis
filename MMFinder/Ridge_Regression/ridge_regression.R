...
output_dir <- "/home/yjliu/mmProj/data_process/Human/Machine_Learning/ridge_regression/"
dir.create(output_dir, recursive = TRUE, showWarnings = FALSE)

pdf(paste0(output_dir, "ridge_regression_ROC_all.pdf"), width = 6, height = 6)
plot(roc_test, col = "darkgreen", lwd = 2, main = "ridge_regression Regression ROC: Test vs External1 vs External2")
...
saveRDS(ridge_model_final, file.path(model_package_dir, "ridge_regression_model.rds"))
